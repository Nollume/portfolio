	...
	return (
		...
		>
			...
			<button
				...
				className=" small:flex-col  small:w-4/5 small:mx-auto small:row-start-3 small:col-start-4 small:h-20 small:my-auto  btn  w-full flex items-center gap-0.5 justify-center cursor-pointer px-4 lg:flex-row xl:col-start-5 xl:col-span-1"
			>
				Certifikáty
				<Certificate />
			</button>
